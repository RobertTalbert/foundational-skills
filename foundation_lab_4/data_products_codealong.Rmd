...
Looked at insights using ggplot What insights did we find?
...
If time allows feel free to add more variables to see if they are
related to time spent, sticking to numeric variables. Were your selected
variables related to time spent in the course?
...
```{r messages=FALSE, warning=FALSE}
apa.reg.table(m1, filename = "lm-table.pdf")
```
...
1.  **Select.** Select a group from above, or a new analysis if so
    motivated, that you think would be interesting or relevant for the
    target audience and that helps answer our research questions.
...
Purpose of this case study is to investigate whether time spent in an
online course is predictive of student achievement.

To do this we looked at a simple correlation between time spent and
student achievement.
...
Knit your data product to a desired output format. This may be a
simple -
[HTML](https://bookdown.org/yihui/rmarkdown/html-document.html), -
[PDF](https://bookdown.org/yihui/rmarkdown/pdf-document.html), or - [MS
Word](https://bookdown.org/yihui/rmarkdown/word-document.html) file; or
something more complex like - [HTML5
